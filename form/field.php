...
abstract class Form_Field {
	...
	public static function Register($name, $class, $file, $module){
		System::Get_Instance()->form['fields'][$name][] = array('class' => $class, 'file' => $file,'module' => $module);
	}
	...
	public static function Create($name, $types){
		...
		foreach($types as $type){
			if(isset(System::Get_Instance()->form['fields'][$type])){
				foreach(System::Get_Instance()->form['fields'][$type] as $info){
					try {
