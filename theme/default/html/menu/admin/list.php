...
class Template_Theme_Default_HTML_Menu_Admin_List extends Template {
	public $menus = array();
	
	public function display(){
?>		
<div class="admin-list menu-admin-list">
	<h1><?php echo $this->title; ?></h1>
	<?php if($this->page > 1){ ?>
	<a class="admin-list-previous menu-admin-list-previous" href="<?php echo $this->pages[$this->page - 1]; ?>">
		<div>&laquo;<?php echo $this->page - 1; ?></div>
	</a>
	<?php } ?>
	<?php if($this->page < $this->page_count){ ?>
	<a class="admin-list-next menu-admin-list-next" href="<?php echo $this->pages[$this->page + 1]; ?>">
