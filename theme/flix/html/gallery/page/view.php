...
class Template_Theme_Flix_HTML_Gallery_Page_View extends Template {

	public function display(){
?>
<div class="page-view gallery page-gallery gallery-view page-gallery-view"> 
...
<?php
			...
			foreach($g['children'] as $child){
				$width = round($percent / $pages, 2);
                		$percent -= $width; $pages --;
?>
			<li <?php if($child['selected']){ ?> class="selected" <?php } ?> 
				style="width: <?php echo $width; ?>%;">
				<a href="<?php echo $child['surl']; ?>"><?php echo $child['title']; ?></a></li> 
<?php
				if($child['selected']){
					$next = $child;
				}
