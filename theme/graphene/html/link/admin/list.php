...
class Template_Theme_Graphene_HTML_Link_Admin_List extends Template {
...
?>		
<div class="admin-list link-admin-list">
	...
	<form id="posts-filter" action="" method="get">
		<p class="search-box">
				<label class="screen-reader-text" for="link-search-input"><?php echo $this->search; ?>:</label>
				<input type="search" id="link-search-input" name="s" value="">
		...
		<input type="hidden" name="content_type" class="content_type_content" value="link">
			...
			<tbody class="link-list-table">
				...
				<tr id="post-161" class="post-161 page type-page status-publish hentry alternate iedit author-self nodate" valign="top">
					...
					<td class="post-title page-title column-title">
						<strong><a class="row-title" href="<?php echo $link['edit']; ?>" title="Edit “<?php echo $link['title']; ?> ”"><?php echo $link['title']; ?> </a></strong>
						<div class="row-actions"><span class="edit"><a href="<?php echo $link['edit']; ?>" title="Edit this item">Edit</a> | </span><span class="inline hide-if-no-js"><a href="#" class="editinline" title="Edit this item inline">Quick&nbsp;Edit</a> | </span><span class="trash"><a class="submitdelete" title="Move this item to the Trash" href="http://philip.whiuk.com/wp-admin/post.php?post=161&amp;action=trash&amp;_wpnonce=f41f60f1c5">Trash</a> | </span><span class="view"><a href="http://philip.whiuk.com/?page_id=161" title="View “About Me”" rel="permalink">View</a></span></div>
