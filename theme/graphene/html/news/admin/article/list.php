...
class Template_Theme_Graphene_HTML_News_Admin_Article_List extends Template {
...
<div class="admin-list content-admin-list">
	...
	<form id="posts-filter" action="" method="get">
		...
		<table class="wp-list-table widefat fixed pages" cellspacing="0">
			<thead>
				<tr>
					...
					<th scope="col" id="comments" class="manage-column column-comments num sortable desc" style="">
						<a href="http://philip.whiuk.com/wp-admin/edit.php?orderby=comment_count&amp;order=asc">
							<span><span class="vers"><img alt="Comments" src="http://philip.whiuk.com/wp-admin/images/comment-grey-bubble.png"></span></span>
							<span class="sorting-indicator"></span>
						</a>
					</th>
			...
			<tfoot>
				<tr>
					...
					<th scope="col" class="manage-column column-title sortable desc" style="">
						<a href="http://philip.whiuk.com/wp-admin/edit.php?post_type=page&amp;orderby=title&amp;order=asc"><span>Title</span><span class="sorting-indicator"></span></a></th>
			...
			<tbody class="news-article-list-table">
				<?php foreach($this->news_articles as $news_article){ ?>
				<tr id="post-161" class="post-161 page type-page status-publish hentry alternate iedit author-self nodate" valign="top">
					...
					<td class="post-title page-title column-title">
						<strong><a class="row-title" href="<?php echo $news_article['edit']; ?>" title="Edit “<?php echo $news_article['title']; ?> ”"><?php echo $news_article['title']; ?> </a></strong>
						<div class="row-actions"><span class="edit"><a href="<?php echo $news_article['edit']; ?>" title="Edit this item">Edit</a> | </span><span class="inline hide-if-no-js"><a href="#" class="editinline" title="Edit this item inline">Quick&nbsp;Edit</a> | </span><span class="trash"><a class="submitdelete" title="Move this item to the Trash" href="http://philip.whiuk.com/wp-admin/post.php?post=161&amp;action=trash&amp;_wpnonce=f41f60f1c5">Trash</a> | </span><span class="view"><a href="http://philip.whiuk.com/?page_id=161" title="View “About Me”" rel="permalink">View</a></span></div>
					...
					<td class="categories column-categories"><a href="edit.php?post_type=post&amp;category_name=updates">Updates</a></td>
					<td class="tags column-tags">No Tags</td>
					<td class="comments column-comments">
						<div class="post-com-count-wrapper">
							<a href="http://philip.whiuk.com/wp-admin/edit-comments.php?p=565" title="0 pending" class="post-com-count">
