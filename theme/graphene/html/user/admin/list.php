...
class Template_Theme_Graphene_HTML_User_Admin_List extends Template {
...
<div class="admin-list user-admin-list">
	...
	<form id="posts-filter" action="" method="get">
		<p class="search-box">
				<label class="screen-reader-text" for="user-search-input"><?php echo $this->search; ?>:</label>
		...
		<input type="hidden" name="content_type" class="content_type_content" value="user">
		...
		<div class="tablenav top">
			...
			<div class="tablenav-pages one-page">
				<span class="displaying-num"><?php echo $this->count; ?> users</span>
		...
		<table class="wp-list-table widefat fixed pages" cellspacing="0">
			<thead>
				<tr>
					...
					<th scope="col" id="id" class="manage-column column-id sortable desc" style="">
						<a href="http://philip.whiuk.com/wp-admin/edit.php?post_type=page&amp;orderby=id&amp;order=asc">
							<span>ID</span>
							<span class="sorting-indicator"></span>
						</a>
					</th>
			...
			<tfoot>
				<tr>
					...
					<th scope="col" class="manage-column column-title sortable desc" style="">
						<a href="http://philip.whiuk.com/wp-admin/edit.php?post_type=page&amp;orderby=title&amp;order=asc"><span>Username</span><span class="sorting-indicator"></span></a></th>
					<th scope="col" class="manage-column column-author sortable desc" style="">
						<a href="http://philip.whiuk.com/wp-admin/edit.php?post_type=page&amp;orderby=author&amp;order=asc"><span>ID</span><span class="sorting-indicator"></span></a>
					</th>
			...
			<tbody class="user-list-table">
				...
				<tr id="post-161" class="post-161 page type-page status-publish hentry alternate iedit author-self nodate" valign="top">
					...
					<td class="post-title page-title column-title">
						<strong><a class="row-title" href="<?php echo $user['edit']; ?>" title="Edit “<?php echo $user['username']; ?> ”"><?php echo $user['username']; ?> </a></strong>
						<div class="row-actions"><span class="edit"><a href="<?php echo $user['edit']; ?>" title="Edit this item">Edit</a> | </span><span class="inline hide-if-no-js"><a href="#" class="editinline" title="Edit this item inline">Quick&nbsp;Edit</a> | </span><span class="trash"><a class="submitdelete" title="Delete user" href="http://philip.whiuk.com/wp-admin/post.php?post=161&amp;action=trash&amp;_wpnonce=f41f60f1c5">Delete</a> | </span><span class="view"><a href="http://philip.whiuk.com/?page_id=161" title="View “About Me”" rel="permalink">View</a></span></div>
					...
					<td class="author column-author"><a href="<?php echo $user['edit']; ?>"><?php echo $user['id']; ?></a></td>
		...
		<div class="tablenav bottom">
			...
			<div class="tablenav-pages one-page"><span class="displaying-num"><?php echo $this->count; ?> users</span>
				<span class="pagination-links">
					<a class="first-page disabled" title="Go to the first page" href="http://philip.whiuk.com/wp-admin/edit.php?post_type=page">«</a>
					<a class="prev-page disabled" title="Go to the previous page" href="http://philip.whiuk.com/wp-admin/edit.php?post_type=page&amp;paged=1">‹</a>
