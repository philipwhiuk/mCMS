...
class Template_Theme_Graphene_HTML_Content_Admin_List extends Template {
			...
			<tbody class="content-list-table">
				...
				<tr id="post-161" class="post-161 page type-page status-publish hentry alternate iedit author-self nodate" valign="top">
					...
					<td class="post-title page-title column-title">
						<strong><a class="row-title" href="<?php echo $content['edit']; ?>" title="Edit “<?php echo $content['title']; ?> ”"><?php echo $content['title']; ?> </a></strong>
						<div class="row-actions"><span class="edit"><a href="<?php echo $content['edit']; ?>" title="Edit this item">Edit</a> | </span><span class="inline hide-if-no-js"><a href="#" class="editinline" title="Edit this item inline">Quick&nbsp;Edit</a> | </span><span class="trash"><a class="submitdelete" title="Move this item to the Trash" href="http://philip.whiuk.com/wp-admin/post.php?post=161&amp;action=trash&amp;_wpnonce=f41f60f1c5">Trash</a> | </span><span class="view"><a href="http://philip.whiuk.com/?page_id=161" title="View “About Me”" rel="permalink">View</a></span></div>
