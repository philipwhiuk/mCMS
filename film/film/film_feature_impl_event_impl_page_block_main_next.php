...
class Film_Film_Feature_Impl_Event_Impl_Page_Block_Main_Next extends Film_Feature_Impl_Event_Impl_Page_Block_Main_Next  {
	...
	function display() {
		...
		$template = $this->system->output()->start(array('film', 'film_feature','event','page','block','next'));
