...
class Film {
	...
	public function Add($data){
		$Storage = MCMS::Get_Instance()->Storage();
		$query = $Storage->insert()->table('film')
			->set(array(
	...
	public function update($data){
		$query = MCMS::Get_Instance()->Storage()->Update()->table('film')
			->set(array(
	...
	public static function Get_All(){
		$query = MCMS::Get_Instance()->Storage()->Get()->From('film');
	...
	public static function Get_By_Feature($feature){
		...
		while($row = $result->fetch_assoc()) {
			$query2 = MCMS::Get_Instance()	->Storage()
			->Select()
			->From('film')
	...
	public static function Get_One($operator, $operand){
		...
		$query = MCMS::Get_Instance()->Storage()->Get()->From('film')->where($operator, $operand)->limit(1);
	...
	public static function Get_By_Language($language){
		...
		$query = MCMS::Get_Instance()->Storage()->Get()->From('film')->where($operator, $operand);
		$result = $query->execute();
		$return = array();
		while($row = $result->fetch_object('Film')){
			$return[] = $row;
	...
	public static function Count_All(){
		$query = MCMS::Get_Instance()->Storage()->Count()->From('film');
