...
class Film_Feature_Event_Impl_Page_Main_View extends Event_Impl_Page_Main_View  {
	function __construct($item) {
		...
		Module::Get('film_feature')->file('film_feature_impl/event_impl_page_main/view');
		$this->films = $feature->get_films();
		$this->implViews = array();
		$class = $feature->get_module()->load_section('Film_Feature_Impl_Event_Impl_Page_Main_View');
