...
class Video_Admin extends Admin {
	...
	public function __construct($a,$b){
		...
		$this->url = $this->url();
		Permission::Check(array('video'), array('view','edit','add','delete','list','admin'),'admin');
	...
	public function display_menu(){
		$template = System::Get_Instance()->output()->start(array('video','admin','menu'));
	...
	public function display_list(){
		$template = System::Get_Instance()->output()->start(array('video','admin','list'));
	...
	public function display_edit(){
		$template = System::Get_Instance()->output()->start(array('video','admin','edit'));
