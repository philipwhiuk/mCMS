...
class Content_Page_Main_Entry_Edit extends Content_Page_Main {
	...
	public function __construct($parent, $content){
		...
		try {
			...
			MCMS::Get_Instance()->redirect($this->parent->url($resource->url()));
	...
	public function display(){
		$template = MCMS::Get_Instance()->output()->start(array('content','page','edit'));
