<?php
class Profile_Exception extends MCMS_Exception {}

class Profile_Page_Exception extends Profile_Exception {}
class Profile_Page_Unavailable_Exception extends Profile_Page_Exception {}

class Profile_User_Page_Exception extends Profile_Exception {}
...
class Profile_Field_Exception extends Profile_Exception {}
class Profile_Field_Unavailable_Exception extends Profile_Field_Exception {}

class Profile_Field_Textbox_Exception extends Profile_Exception {}
