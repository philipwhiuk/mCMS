...
class Image_Gallery_Item extends Gallery_Item {
	...
	public function previous(){
		$query = MCMS::Get_Instance()->Storage()->Get()->From('gallery_image')->where('AND', array(
	...
	public static function Get_One($operator, $operand){
		...
		$query = MCMS::Get_Instance()->Storage()->Get()->From('gallery_image')->where($operator, $operand)->limit(1);	
		$result = $query->execute();
	...
	public static function Get_By_Gallery($gallery, $offset, $limit){
		...
		$query = MCMS::Get_Instance()->Storage()->Get()->From('gallery_image')
