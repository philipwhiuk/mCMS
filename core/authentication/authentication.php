...
abstract class Authentication {
	...
	private static function Load(){
		if(!isset(MCMS::Get_Instance()->authentication_plugins)){
			MCMS::Get_Instance()->authentication_plugins = self::Get_Load();
		}
	}
	
	private static function Get_Load(){
		$query = MCMS::Get_Instance()->storage()->Get()->From('authentication')->where(
			'=', array(
				array('col', 'active'),
				array('u',1)
			)
	...
	public static function Retrieve(){
		if(isset(MCMS::Get_Instance()->authentication_user)){
			return MCMS::Get_Instance()->authentication_user;
		}
		...
		foreach(MCMS::Get_Instance()->authentication_plugins as $auth){
			try {
	...
	public static function Release(){
		...
		unset(MCMS::Get_Instance()->authentication_user);
